...
Daenerys quer conquistar uma aldeia com os seus dois dragões. 
Cada dragão mata 32 ovelhas e 90 pessoas a cada 1 hora. 
Considerando que ela atacará a aldeia por 4h, quantas ovelhas e pessoas ao todo os dragões irão assassinar após o ataque?
...
# Desafio 2
Crie variáveis para os casos abaixo (cuidado com os nomes dados! Usaremos nos próximos desafios!): 
- DC com valor 42
- Marvel com valor 23
- Herói com valor Superman
- Vingadores com valor 63
...
Converta a variável Vingadores criada anteriormente para character. Agora cheque sua classe. O que acontece com seu valor?
...
Converta a variável Vingadores criada anteriormente para character. 
...
- glimpse(): mostra várias informações, como o número de observações (linhas) e variáveis (colunas), o nome das colunas e o tipo delas.
...
Mariana Dias Guilardi [] <br></br>
Patricia Guisordi [] <br></br>
