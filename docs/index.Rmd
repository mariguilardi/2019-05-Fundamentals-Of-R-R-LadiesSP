...
# Desafio 2
Crie variáveis para os casos abaixo:
...
São os tipos básicos de dados que podem ser representados na linguagem R. É neles que guardamos as informações que necessitamos pra um algoritmo.
...
Converta a variável Vingadores criada anteriormente para character. Agora cheque sua classe. O que acontece com seu valor? Como explica o que aconteceu?
